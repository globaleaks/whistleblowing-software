...
if [ "$GLTEST" = "test" ]; then
  ...
  declare -a capabilities=(
    ...
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Chrome\", \"platformName\":\"Android GoogleAPI Emulator\", \"platformVersion\": \"10.0\", \"deviceName\": \"Android Emulator\", \"deviceOrientation\": \"portrait\", \"maxDuration\":\"7200\", \"commandTimeout\":\"600\", \"idleTimeout\":\"270\"}'"
