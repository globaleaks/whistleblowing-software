describe("admin configure, add, and delete tenants", () => {
  ...
  it("should add new tenant", () => {
    ...
    cy.takeScreenshot("admin/sites_management_sites.png");
  });

  it("should delete existing tenants", () => {
    cy.get("button").contains("Delete").last().click();
    cy.get("#modal-action-ok").click();
  });

  it("should configure sites options", () => {
    cy.contains("a", "Options").click();
    cy.takeScreenshot("admin/sites_management_options.png");
    cy.logout();
  });
});
