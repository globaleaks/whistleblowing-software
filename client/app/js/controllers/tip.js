GL.controller("TipCtrl", ["$scope", "$location", "$filter", "$http", "$interval", "$routeParams", "$uibModal", "Authentication", "RTip", "WBTip", "RTipExport", "RTipDownloadRFile", "RTipFileSourceGet", "WBTipFileSourceGet", "WBTipDownloadFile", "fieldUtilities", "RTipViewRFile", "$timeout",
...
controller("TipOperationsCtrl",	["$scope", "$http", "$location", "$uibModalInstance", "args",
...
controller("IdentityAccessRequestCtrl", ["$scope", "$http", "$uibModalInstance", "tip",
