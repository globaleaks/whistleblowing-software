...
.service('glbcUserKeyGen', ['$q', '$http', '$timeout', 'Authentication', 'glbcKeyLib', 'glbcKeyRing', function($q, $http, $timeout, Authentication, glbcKeyLib, glbcKeyRing) { 
  var vars = {
    msgQueue: [],  
    promises: {
      keyGen: $q.defer(),
  ...
  var msgP = $q(function(resolve) {
    resolve();
  });
  function showMsg(msg) {
    console.log(msg);
    msgP = msgP.then(function() {
