...
if [ "$GLTEST" = "test" ]; then
  ...
  declare -a capabilities=(
    ...
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Firefox\", \"version\":\"34\", \"platform\":\"OS X 10.10\", \"seleniumVersion\":\"3.4.0\"}'"
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Firefox\", \"version\":\"54\", \"platform\":\"Windows 10\", \"seleniumVersion\":\"3.4.0\"}'"
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Chrome\", \"version\":\"37\",  \"platform\":\"OS X 10.10\", \"seleniumVersion\":\"3.4.0\"}'"
    "export SELENIUM_BROWSER_CAPABILITIES='{\"browserName\":\"Chrome\", \"version\":\"59\", \"platform\":\"Windows 10\", \"seleniumVersion\":\"3.4.0\"}'"
