...
class TestMessages(unittest.TestCase):
    ...
    def test_file_dict(self):
        test_fd = shared.fileDicts[0].copy()
    ...
    def test_folder_dict(self):
        message = json.dumps(shared.folderDict)
        validateMessage(message, folderDict)

    def test_invalid_folder_dict(self):
        invalid_fd = shared.folderDict.copy()
    ...
    def test_receiver_dict(self):
        message = json.dumps(shared.receiverDescriptionDicts[0])
        validateMessage(message, receiverDescriptionDict)

    def test_invalid_receiver_dict(self):
        invalid_rd = shared.receiverDescriptionDicts[0].copy()
    ...
    def test_admin_statistics(self):
        message = json.dumps(shared.adminStatisticsDict)
