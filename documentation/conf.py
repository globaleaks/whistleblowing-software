...
# of the sidebar.
html_logo = '../client/app/data/logo.png'
...
latex_documents = [
    (master_doc, 'GlobaLeaks.tex', u'GlobaLeaks Documentation',
     u'Hermes Center for Transparency and Digital Human Rights', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = '../client/app/data/logo.png'
