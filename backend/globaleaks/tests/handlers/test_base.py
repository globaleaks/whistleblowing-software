...
class TestTimingStats(helpers.TestHandler):
    ...
    def test_get_feature_enabled(self):
        ...
        self.assertEqual(splits[3], "token,POST,/token,1443252280.0,0")
        self.assertEqual(splits[4], "submission,PUT,/submission/XXA82cSXFHTOoVroWlOGqg2VF8XtJQ57QIYM09YanY,1443252281.0,0")
        self.assertEqual(splits[5], "comment,POST,/wbtip/comments,1443252282.0,0")
