...
class _Context(Model):
    ...
    tip_reminder_hard = Column(Integer, default=10, nullable=False)
    tip_reminder_soft = Column(Integer, default=15, nullable=False)
...
class _InternalTip(Model):
    ...
    reminder_notification_status = Column(Boolean, default=False, nullable=False)
    enable_two_way_comments = Column(Boolean, default=True, nullable=False)
    enable_two_way_messages = Column(Boolean, default=True, nullable=False)
    enable_attachments = Column(Boolean, default=True, nullable=False)
