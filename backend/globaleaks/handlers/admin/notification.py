...
class EmailNotifInstance(BaseHandler):
    ...
    Understand that this handler blocks its thread until both the db query
    and the SMTP round trip return.
    """
    ...
    def post(self):
      ...
      try: 
        ...
        msg = "This is a test email generated by the GlobaLeaks administration interface.\n"+\
        "If you were not expecting this email, please contact the owner of this email address."
        result = yield sendmail(send_to, 'Test Email Config', msg)  
        self.set_status(200)
      except Exception as e:
        log.debug("Sending test email failed.")
