...
class Session(object):
    def __init__(self, tid, user_id, user_tid, user_name, user_role, cc='', ek=''):
...
class SessionsFactory(TempDict):
    ...
    def new(self, tid, user_id, user_tid, user_name, user_role, cc='', ek=''):
        self.revoke(tid, user_id)
        session = Session(tid, user_id, user_tid, user_name, user_role, cc, ek)
