...
class Session(object):
    def __init__(self, tid, user_id, user_tid, user_role, pcn, cc):
...
class SessionsFactory(TempDict):
    ...
    def new(self, tid, user_id, user_tid, user_role, pcn, cc):
        self.revoke(tid, user_id)
        session = Session(tid, user_id, user_tid, user_role, pcn, cc)
